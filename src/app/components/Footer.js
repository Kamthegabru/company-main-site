          ...
          <div className="grid grid-cols-12 gap-8">
            ...
            <div className="col-span-12 lg:col-span-7">
              <div className="footer-widget logo-widget">
               <Link href="./" className="flex items-center w-[120px] gap-3 select-none cursor-pointer">
            ...
            <div className="col-span-12 lg:col-span-5">
              <div className="footer-widget links-widget">
                ...
                <ul className="list-link">
                  ...
                  <li><Link href="#">IT support &amp; helpdesk</Link></li>
                  <li><Link href="#">Cyber security</Link></li>
                  <li><Link href="#">Custom Software</Link></li>
                  <li><Link href="#">Free Consultation</Link></li>
                  <li><Link href="#">Our Business Growth</Link></li>
                </ul>
              </div>
            </div>
          </div>
...
Portland, OR 97210
                  ...
                  <li>
                    ...
                    <div>
                      <strong>Phone</strong>
                      <Link href="tel:+78687586475" className="text-white hover:underline">(206)571-7659</Link>
                    </div>
                  </li>
                  <li>
                    <span className="icon">
                    ...
                    <div>
                      ...
                      <Link href="mailto:info@seatechconsulting.com" className="text-white hover:underline">info@seatechconsulting.com</Link>
                    </div>
                  </li>
                </ul>
              </div>
      ...
      <div className="grid grid-cols-1 gap-4 md:grid-cols-2 items-center">
        <div className="text-center md:text-left">
          <div className="text-sm text-[#c9d3df]">
            Copyright © 2024 by expert-themes. All Rights Reserved.
          </div>
        </div>
        <div className="md:text-right">
          <ul className="footer-nav justify-center md:justify-end">
            <li><Link href="#about">About Us</Link></li>
            <li><Link href="#what">Services</Link></li>
            <li><Link href="/privacy-policy">Privay</Link></li>
          </ul>
        </div>
      </div>
    </div>
