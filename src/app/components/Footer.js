...
Portland, OR 97210
                  ...
                  <li>
                    ...
                    <div>
                      <strong>Phone</strong>
                      <a href="tel:+78687586475" className="text-white hover:underline">(206)571-7659</a>
                    </div>
                  </li>
                  <li>
                    <span className="icon">
                    ...
                    <div>
                      ...
                      <a href="mailto:info@seatechconsulting.com" className="text-white hover:underline">info@seatechconsulting.com</a>
                    </div>
                  </li>
                </ul>
              </div>
